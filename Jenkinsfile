        ...
        stage('Get Project Version') {
            steps {
                script {
                    ...
                    sh "./gradlew release -Prelease.customUsername='patry77' -Prelease.customPassword='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'"
